...
public class All_Teams extends AppCompatActivity {
    ...
    ProgressDialog pd;
    Adapter_All_Teams adapter_online;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter_online = new Adapter_All_Teams(All_Teams.this , modelOnlines_list);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(All_Teams.this, ""+ error.getMessage(), Toast.LENGTH_SHORT).show();
                pd.dismiss();
            }
        });
